...
This tree is the `3.0.0-rc.4` bounded external-pilot candidate.
...
All current verification resolves Language `3.1.0-rc.22`, BEX
...
published dependencies. `verifyRcReadiness` adds exact rc.4 policy and graph
...
authorizes the semantic bounded-pilot profile. Its invocation-local artifact
