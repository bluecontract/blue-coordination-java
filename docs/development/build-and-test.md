...
Contracts release gate. Its retained RC lock template still pins Language
RC25, independently of the current published release tuple. Its absolute path
and exact manifest identity are both required:
