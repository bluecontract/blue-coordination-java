...
`3.0.0-rc.9` is authorized as a bounded external-pilot release candidate
...
[rc.9 release decision](../releases/3.0.0-rc.9.md).
...
The complete current release gate and focused rc.9 capability inventory are
...
workflow prepares rc.9 and seals a local verification commit before running
...
4. for RCs, prepares the version authorized by `docs/releases/3.0.0-rc.9.md`;
...
8. runs the complete Java 21 `releaseCheck` and Java 17 `stageRelease`
   concurrently; staging includes the complete release and rc.9 gates;
...
performance exception is rc.1-specific and is not part of rc.9 or any future
stable release.
