...
final class BasicEngineTestSupport {
    private BasicEngineTestSupport() {
    }

    static String resource(String path) throws Exception {
        return BasicTestResources.read(path);
    }
    ...
    static long integer(BasicCoordinationEngine engine, String doc, String path) {
    ...
    static String text(BasicCoordinationEngine engine, String doc, String path) {
